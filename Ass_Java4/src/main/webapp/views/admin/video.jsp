				...
				<div class="row" style="text-align: left;">
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="home-tab"
								...
								aria-selected="true">Video Editing</button>
						</li>
						<li class="nav-item" role="presentation">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="home-tab-pane"
							...
							<form style="width: 1200px" action="Ass_Java4/VideoServlet"
								method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-3">
										<div class="border p-3">
											<img alt=""
												src="${video.poster != null ? video.poster: 'images/1001.jpg'}"
												class="img-fluid">
									...
									<div class="col-9">
										<div class="form-group">
											<label for="youtubeId">VideoId</label> <input
												value="${video.videoId}" name="videoId" type="text"
												placeholder="youTubeId" aria-describedby="youTubeId"
												class="form-control" id="videoId">
										</div>
										<div class="form-group">
											<label for="youtubeTitle">Video Title</label> <input
												value="${video.title}" name="title" type="text"
												placeholder="youTubetitle" aria-describedby="youTubetitle"
												class="form-control" id="title">
										</div>
										<div class="form-group">
											<label for="youtubeview">Video Count</label> <input
												value="${video.views}" name="views" type="text"
												placeholder="youTubeviews" aria-describedby="youTubeviews"
												class="form-control" id="views">
										</div>
										<div class="form-check form-check-inline">
											<label> <input type="radio" class="form-check-input"
												value="true" ${video.active? 'checked':''} name="active"
												id="status">Active
											</label><br> <label> <input type="radio"
												class="form-check-input" value="false"
												${!video.active? 'checked':''} name="active" id="status">In
												Active
											</label>
										</div>
									</div>
								...
								<div class="row">
									<div class="col">
										...
										<textarea name="description" id="description" rows="4"
											cols="30" class="form-control">${video.description}</textarea>
										<hr>
							...
							<table class="table table-striped table-hover">
								...
								<c:forEach var="item" items="${items}">
									<tr>
										...
										<td><a href="/Ass_Java4/VideoServlet/edit?videoId=${item.videoId}"><i
												class="fa fa-edit" aria-hidden="true"></i>Edit</a> <a
											href="/Ass_Java4/VideoServlet/delete?videoId=${item.videoId}"><i

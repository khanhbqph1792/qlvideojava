					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="home-tab-pane"
							...
							<form action="" method="post">
											...
											<div class="col">
												<div class="form-group">
													<label for="username">Username</label> <input
														value="${nguoi.userId}" type="text" class="form-control"
														name="userId" id="userId" aria-describedby="userIdHId"
														placeholder="Username"> <small id="userIdHId"
														class="form-text text-muted">Username is required!</small>
												</div>
												<div class="form-group">
													<label for="fullname">Fullname</label> <input
														value="${nguoi.fullname}" type="text" class="form-control"
												...
												<div class="form-group">
													<label>Role:</label><br> <label class="ml-2"><input
														${nguoi.admin?'':'checked'} type="radio" name="admin"
														value="true" class="form-check-input">Admin</label><br>
											...
											<div class="col">
												<div class="form-group">
													<label for="password">Password</label> <input
														value="${nguoi.password}" type="password"
												...
												<div class="form-group">
													<label for="email">Email</label> <input
														value="${nguoi.email}" type="text" class="form-control"
								...
								<button formaction="/Ass_Java4/UserServlet/insert"
									class="btn btn-primary">Create</button>
								<button formaction="/Ass_Java4/UserServlet/update"
									class="btn btn-warning">Update</button>
								<button formaction="/Ass_Java4/UserServlet/reset"
							...
							<table class="table table-striped table-hover">
								...
								<c:forEach var="item" items="${items}">
									<tr>
										...
										<td><a
											href="/Ass_Java4/UserServlet/edit?userId=${item.userId}"><i
												class="fa fa-edit" aria-hidden="true"></i>Edit</a> <a
											href="/Ass_Java4/UserServlet/delete?userId=${item.userId}"><i
